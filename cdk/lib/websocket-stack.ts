...
export class WebSocketStack extends cdk.Stack {
    ...
    constructor(scope: Construct, id: string, props?: cdk.StackProps) {
        ...
        // Create translation cache table for medical phrases
        ...
        // Add GSI for querying cache by language pair
        ...
        const bedrockAiLogGroup = new logs.LogGroup(this, 'BedrockAiHandlerLogGroup', {
            logGroupName: '/aws/lambda/healthcare-translation-bedrock-ai',
            retention: logs.RetentionDays.ONE_WEEK,
            removalPolicy: cdk.RemovalPolicy.DESTROY,
        });

        const translationLogGroup = new logs.LogGroup(this, 'TranslationHandlerLogGroup', {
            logGroupName: '/aws/lambda/healthcare-translation-service',
            retention: logs.RetentionDays.ONE_WEEK,
            removalPolicy: cdk.RemovalPolicy.DESTROY,
        });
        ...
        // Bedrock AI enhancement Lambda function
        const bedrockAiHandler = new lambda.Function(this, 'BedrockAiHandler', {
            runtime: lambda.Runtime.NODEJS_20_X,
            handler: 'index.handler',
            code: lambda.Code.fromAsset('lambda/bedrock-ai'),
            role: lambdaExecutionRole,
            environment: {
                CONNECTIONS_TABLE: this.connectionsTable.tableName,
                SESSIONS_TABLE: this.sessionsTable.tableName,
            },
            logGroup: bedrockAiLogGroup,
            timeout: cdk.Duration.minutes(10), // Extended timeout for AI processing
            memorySize: 1024, // More memory for AI model invocations
        });

        // Translation service Lambda function
        const translationHandler = new lambda.Function(this, 'TranslationHandler', {
            runtime: lambda.Runtime.NODEJS_20_X,
            handler: 'index.handler',
            code: lambda.Code.fromAsset('lambda/translation'),
            role: lambdaExecutionRole,
            environment: {
                CONNECTIONS_TABLE: this.connectionsTable.tableName,
                SESSIONS_TABLE: this.sessionsTable.tableName,
                TRANSLATION_CACHE_TABLE: translationCacheTable.tableName,
            },
            logGroup: translationLogGroup,
            timeout: cdk.Duration.minutes(5), // Extended timeout for translation processing
        ...
        // Add Bedrock AI routes
        const bedrockAiIntegration = new WebSocketLambdaIntegration('BedrockAiIntegration', bedrockAiHandler);

        new apigatewayv2.WebSocketRoute(this, 'EnhanceTranscriptRoute', {
            webSocketApi: this.webSocketApi,
            routeKey: 'enhanceTranscript',
            integration: bedrockAiIntegration,
        });

        new apigatewayv2.WebSocketRoute(this, 'NormalizeTerminologyRoute', {
            webSocketApi: this.webSocketApi,
            routeKey: 'normalizeTerminology',
            integration: bedrockAiIntegration,
        });

        new apigatewayv2.WebSocketRoute(this, 'EnhanceTranslationRoute', {
            webSocketApi: this.webSocketApi,
            routeKey: 'enhanceTranslation',
            integration: bedrockAiIntegration,
        });

        new apigatewayv2.WebSocketRoute(this, 'DetectMedicalContextRoute', {
            webSocketApi: this.webSocketApi,
            routeKey: 'detectMedicalContext',
            integration: bedrockAiIntegration,
        });

        new apigatewayv2.WebSocketRoute(this, 'ScoreConfidenceRoute', {
            webSocketApi: this.webSocketApi,
            routeKey: 'scoreConfidence',
            integration: bedrockAiIntegration,
        });

        // Add translation service routes
        const translationIntegration = new WebSocketLambdaIntegration('TranslationIntegration', translationHandler);

        new apigatewayv2.WebSocketRoute(this, 'TranslateTextRoute', {
            webSocketApi: this.webSocketApi,
            routeKey: 'translateText',
            integration: translationIntegration,
        });

        new apigatewayv2.WebSocketRoute(this, 'TranslateWithContextRoute', {
            webSocketApi: this.webSocketApi,
            routeKey: 'translateWithContext',
            integration: translationIntegration,
        });

        new apigatewayv2.WebSocketRoute(this, 'ClearTranslationCacheRoute', {
            webSocketApi: this.webSocketApi,
            routeKey: 'clearTranslationCache',
            integration: translationIntegration,
        });
        ...
        this.connectionsTable.grantReadWriteData(bedrockAiHandler);
        this.sessionsTable.grantReadWriteData(bedrockAiHandler);
        ...
        new cdk.CfnOutput(this, 'SessionsTableOutput', {
